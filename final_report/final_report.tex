...
The PTD designed follows the block diagram in Figure: \textcolor{Red}{number}  shows that all sub-system functions have been used to complete with the clients expectations.
...
at 4800 BOD.
\textcolor{Red}{Put block diagram here}
...
The PTD shall meet the following physical requeirements:
    \subparagraph{Form Factor}  The PTD shall conform to the following form factor: 16cm by 8cm by 5cm This is a test to see what is happeneind with the hanging indent 
        \begin{description}
            \setlength{\itemindent}{1em}
            \item{\textbf{Test} -} The PTD shall be placed in an small box of dimention stated in requirements.
            \item{\textbf{Result} -} \textcolor{Red}{Talk about results}
        \end{description}
...
The PTD shall meet the following electrical requirements:
    \subparagraph{Power Constraints}  The PTD shall operate using the power provided by a standard ATV battery, specifically, 12V 11Ah battery.
        \begin{description}
            ...
            \item{\textbf{Result} -} \textcolor{Green}{Talk about results}
        \end{description}
    \subparagraph{Prototype Connections}  For the purposes of proof of concept the PTD may make use of a breadboard to connect the components.
        \begin{description}
            \setlength{\itemindent}{1em}
            \item{\textbf{Test} -} The PTD shall have connections that function, The design of these connections is not specified in the \textit{Specifications Document}.
                \hspace*{4cm}requirements.
            \item{\textbf{Result} -} \textcolor{Green}{Talk about results}
        \end{description}
...
environments that would control the design.
    ...
    \subparagraph{Vibration Test}  The PTD shall withstand vibrations of 1 ocilations per second with an amplitude of 1.5cm for 1 hour.
        \begin{description}
            \setlength{\itemindent}{1em}
            \item{\textbf{Test} -} The PTD shall function after the viberation test is performed.
                \hspace*{4cm}requirements.
            \item{\textbf{Result} -} \textcolor{Green}{Talk about results}
        \end{description}
...
environments that would control the design.
    ...
    \subparagraph{Dust Test}  The PTD shall function in a dusty environment, specifically, the shock and vibration tests shall be repeated 
        after 15 grams of fine sand is applied to the device. \newline ~ \newline 
        Like most American households I didn't has a food scale available so I used a little math to estimate the volume of dirt necessary to represent 15 grams. I know that 4 grams of sugar is about
        one teaspoon of sugar. Using this rough estimate I used my wifes measuring spoons\footnote{I don't think my wife enjoys it when my experiments infringe on her cooking utinsals.} to gather 4 
        teaspoons of dirt which I placed in a box with the PTD. I then closed up the box and repeated the shock and vibrations tests. I then used an air compressor to clean off the PTD before verifying
        that the PTD worked and function was not degraded by the stress.
